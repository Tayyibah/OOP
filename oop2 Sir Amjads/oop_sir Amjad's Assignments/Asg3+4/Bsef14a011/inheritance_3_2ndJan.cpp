...
//void main()
//{
//	/* Issue with redefining. */
//	PassFailActivity pf(50);
//	pf.setScore(85);
//	displayGrade(pf);
//
//	/* Issue error. */
//	GradedActivity *gptr = new GradedActivity(80);
//	MidExam *midptr = static_cast<MidExam *> (gptr);
//	cout << "\n\n" << midptr->getLetterGrade() << endl;
//	cout << midptr->getPointsEach() << endl;
//	cout << "\n\n";
//	/* Virtual Destructor */
//	/*Animal *ptr = new Cat();
//	delete ptr;*/
